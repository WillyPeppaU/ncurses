...
int main(int argc, const char * argv[]) {
    ...
    while((a=getch())!= '0'){
        if ((a>='a')&&(a<='z')){
            ...
            wrefresh(ventana_izquierda);
            mvwprintw(ventana_derecha, fila_der, col_der, "La letra ingresada es %c",a);   //quisiste decir _-_--_-__-_--_-_ sugerencia
            wrefresh(ventana_derecha);
            fila_izq+=1;
            fila_der+=1;
